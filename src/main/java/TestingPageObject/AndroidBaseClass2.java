...
public class AndroidBaseClass2  {

    private AppiumDriver driver;

    public AndroidBaseClass2(AppiumDriver driver) {
        this.driver = driver;
    }


    protected boolean isDisplayed(AndroidElement id) {
        driver.findElement(By.id(String.valueOf(id))).isDisplayed();
        return true;
    }
    protected void clickByElement(AndroidElement id) {
        driver.findElement(By.id(String.valueOf(id))).click();
    }
    protected void sendKeysToElement(AndroidElement id, String inputText) {
        driver.findElement(By.id(String.valueOf(id))).sendKeys(inputText);
    }
