...
class MoveToSold : BaseTestClass() {
    ...
    /*@Test
    fun moveToSoldTest() {
        TODO("Ждем пока ребята починят, товар на продаже со статусом продано")
        ...
        productCardInterface.clickSendToSold()
        productCardInterface.assertSoldStatus()
        productCardInterface.clickBack()
        myProductsInterface.waitMyProductsPage()
